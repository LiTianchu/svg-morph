            ...
            <div className="App">
                <header className="App-header">
                    <div className="initial-svg-loading" role="status">
                        {initialSvgLoadError ? (
                            <p>
                                Unable to load the demo SVGs. Please refresh the
                                page.
                            </p>
                        ) : (
                            <>
        ...
        <div className="App">
            <header className="App-header">
                ...
                >
                    ...
                    >
                        <MorphSettingPanel
                            onSettingChange={setSvgMorphingSettings}
                        />
                        <ExportSettingPanel
                            onExportSettingChange={setExportSettings}
                        />
                    </div>
                </div>
            </header>
